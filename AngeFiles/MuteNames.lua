...
if DevANGEL:get(ANGEL.."ANGEL:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevANGEL:sadd(ANGEL.."ANGEL:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevANGEL:srem(ANGEL.."ANGEL:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevANGEL:del(ANGEL.."ANGEL:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌔︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevANGEL:smembers(ANGEL.."ANGEL:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevANGEL:get(ANGEL.."ANGEL:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
ANGELName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if ANGELName then 
ANGELNames = DevANGEL:smembers(ANGEL.."ANGEL:Mute:Names"..msg.chat_id_) or ""
if ANGELNames and ANGELNames[1] then 
for i=1,#ANGELNames do 
if ANGELName:match("(.*)("..ANGELNames[i]..")(.*)") then 
...
DevANGEL:set(ANGEL.."ANGEL:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevANGEL:del(ANGEL.."ANGEL:Lock:MuteNames"..msg.chat_id_)
end
end
end
